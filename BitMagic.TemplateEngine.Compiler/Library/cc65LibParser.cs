...
public static class Cc65LibParser
{
    ...
    // private static void DisplayInfo(Cc65Lib l)
    // {
    ...
    //                         Console.Write($" ; {l.StringPool[(int)linfo.Filename_stringId]} : {linfo.Line} = ");
    //                     }
    //                     break;
    //             }
    //             Console.WriteLine();
